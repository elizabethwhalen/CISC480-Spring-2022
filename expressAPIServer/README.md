...
### Connection via cURL
From another terminal, submit HTTP requests to "http://localhost:4000". Some examples to connect to the API via [cURL](https://curl.se/)
...
### Connection via cURL
From another terminal, submit HTTP requests to "http://classy-schedule-api.ddns.net". Some examples to connect to the API via [cURL](https://curl.se/)
